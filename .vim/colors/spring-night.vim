...
call s:hi('Directory',    s:white,      0,            0)
...
call s:hi('FoldColumn',   s:gray,            s:bgemphasis, 0)
call s:hi('Folded',       s:purple,     s:light,      0)
call s:hi('Function',     s:red,     0,            0)
call s:hi('Identifier',   s:white,       0,            'italic')
call s:hi('Keyword',      s:yellow,     0,            'bold')
call s:hi('Label',        s:white,    0,            0)
...
call s:hi('Number',       s:skyblue,        0,            0)
...
call s:hi('Question',     s:white,    0,            0)
